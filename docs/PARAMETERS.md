...
|---|---|---|---|---|
| `T` | `time_T` | `1` | 0 to 18 | Master clock. Press play. |
...
| `e_0` | `eps` | `0.8` | 0.3 to 2 | Well softening. |
...
| `g_r` | `phys_gr` | `1.8` | Ringdown over contact GW frequency (real about 3.9; capped for grid resolution). |
| `A_p` | `phys_ap` | `1.6` | Merger peak wave amplitude, relative. |
